...
[*Please refer to Appendix 1 for the relationship sets between the key entities.*]{.underline}

![Initial ER Diagram](images/ER_Initial.drawio.png){fig-align="center"}
...
4.  AD(ad_id, product_id, url, ad_start_date, ad_end_date, discount)
...
10. Discounted_price (for the Product), total_amount (for the Order) and total_value (for the Transaction) are derived attributes, which we do not include on the ER diagram or the schema, but we can calculate them using SQL later on.
...
![GitHub Repository](images/GitHub_Repo.png){fig-align="center"}
...
![Workflow Setup](images/Workflow_Setup.png){fig-align="center"}
...
2.  Package installations and database creation: Required R packages are installed, and the \`db_creation.R\` script builds the database, followed by the addition of changes to the \`DATABASE\` folder.\
    ![Workflow for Database Creation using RScript](images/Database_Creation_and_Validation-01.png)
...
![Workflow for Data Analysis using R and Pushing Changes](images/Data_Analysis.png){fig-align="center"}
...
![Average Time Until Order Fulfillment](images/avg_fulfillment_2023.png){fig-align="center"}
...
![Average Order Value](images/avg_order_value_2023.png){fig-align="center"}
...
![Cumulative Customer Growth](images/cumulative_customers_2023.png){fig-align="center"}
...
![Age Distribution of Customers](images/customer_age_2023.png){fig-align="center"}
...
![Monthly Sales Over Time](images/monthly_sales_2023.png)
...
![Sales by Category](images/sales_by_categories_2023.png){fig-align="center"}
...
![Top 10 Cities by Sales](images/top_cities_2023.png){fig-align="center"}
...
![Average Rating by Category](images/top_rated_products_2023.png){fig-align="center"}
